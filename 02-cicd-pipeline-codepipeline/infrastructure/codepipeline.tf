...
resource "aws_iam_role" "codebuild_role" {
  name                  = "${var.project_name}-codebuild-role-${random_string.suffix.result}"
...
resource "aws_iam_role" "codepipeline_role" {
  name                  = "${var.project_name}-codepipeline-role-${random_string.suffix.result}"
  force_detach_policies = true
...
resource "aws_codepipeline" "pipeline" {
  name     = "${var.project_name}-pipeline-${random_string.suffix.result}"
